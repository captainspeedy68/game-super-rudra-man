...
class Level:
    ...
    def setup(self, tmx_map):
        ...
        for obj in tmx_map.get_layer_by_name("Objects"):
            if obj.name == "player":
                self.player = Player((obj.x, obj.y), self.all_sprites, self.collsion_sprites, self.semi_collision_sprites)
        ...
        for obj in tmx_map.get_layer_by_name("Moving Objects"):
            if obj.name == "helicopter":
                ...
                MovingSprites((self.all_sprites, self.semi_collision_sprites), start_pos, end_pos, move_dir, speed)
